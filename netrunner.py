        ...
        match currentState:
            ...
            case "ripperdoc":
                if not name:
                    ...
                    name = resp
                    resp = None
                    print(name + "'Huh? Looks like your a real nobody kid, but hey that's not the worse thing. Just looking at ya I can tell you don't have any money. Hell I almost pity you. I'll tell you what, since I'm out right now, how about you run the shop for a bit?'\n...'Alrighty then keep heading down to the basement, once you're there go ahead and get setup on my rig. I'll explain the rest once you're in.")
